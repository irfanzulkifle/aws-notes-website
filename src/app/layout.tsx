...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body className={`${inter.className} min-h-screen flex flex-col bg-white dark:bg-[#0B0F1A] text-gray-900 dark:text-slate-200`}>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[100] focus:px-4 focus:py-2 focus:rounded-lg focus:bg-indigo-600 focus:text-white focus:text-sm focus:outline-none"
        >
          Skip to content
        </a>
        <Analytics />
        ...
        <nav className="sticky top-0 z-50 glass border-b border-gray-200/50 dark:border-slate-700/50">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/"
                className="text-sm text-gray-600 dark:text-slate-400 hover:text-gray-900 dark:hover:text-slate-100 transition-colors hidden sm:block"
              >
                All Notes
              </Link>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-lg flex items-center justify-center text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
                aria-label="GitHub"
              >
        ...
        <footer className="border-t border-gray-100 dark:border-slate-800 py-12">
          <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-6 text-sm text-gray-400 dark:text-slate-500">
